...
void redfix () {
  if (wind == 1 && redtime == 0) {
    PARTICLE_SENSOR.setup(220, sampleAverage, ledMode, sampleRate, pulseWidth, adcRange);
  } 
  if (wind == 0 && redtime > 0) {
    PARTICLE_SENSOR.setup(0, sampleAverage, ledMode, sampleRate, pulseWidth, adcRange);
    redtime = 0;
  }
}
...
void printCursorS(int x,int y, const String& mas) {
  u8g2.setCursor(x,y);
  u8g2.print(mas);
}
...
void printCursorF(int x,int y, float coca) {
  u8g2.setCursor(x,y);
  u8g2.print(coca);
}
//////////////////////////////////////////////////////////////////////////// ламповий сетапчик
  ...
  switch (wind) {
    ...
    case 0:                               /////////
      ...
      do {
        ...
        printCursorS (95,12,uap1[6]);


        printCursorF (0,29,temp);
        printCursorS (36,29,uap1[7]);


        printCursorF (61,29,flux);
        if (flux < 1000) {
          if (flux < 10) {
        ...
        printCursorS (0,45,uap1[9]);
        printCursorF (60,45,pressure*0.00750063755419211);
        printCursorS (105,45,uap1[10]);

        printCursorS (0,63,uap1[11]);
        printCursor (40,63,ppm);
        printCursorS (75,61,uap1[12]);
    ...
    case 1:                                 //////////
      ...
      do {
        ...
        if (irValue > 50000) {
          ...
          printCursorS (0,15,uap2[0]);
          printCursor (33,15,irValue);


          printCursorS (0,32,uap2[1]);
          printCursor (48,32,beatsPerMinute);


          printCursorS (0,47,uap2[2]);
          printCursor (81,47,beatAvg);
        } else {

          printCursorS (0,32,uap2[3]);
          printCursorS (0,50,uap2[4]);
...
// функція 
// добавити часи
// таймер возврата на главний дісплей