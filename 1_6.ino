...
//U8G2_SSD1327_EA_W128128_F_4W_HW_SPI u8g2(U8G2_R0, /* cs=*/ 5, /* dc=*/ 16, /* reset=*/ 17); // середьня яркость
//U8G2_SSD1327_WS_128X128_F_4W_HW_SPI u8g2(U8G2_R0, /* cs=*/ 5, /* dc=*/ 16, /* reset=*/ 17); // висока яркость
...
void setup(void) {
  ...
  u8g2.begin();
  u8g2.drawBitmap(0, 0, 8, 64, Pic.logo);
  u8g2.sendBuffer();
  delay(1000);
...
//////////////////////////////////////////////////////////////////////////////   Графіка
  ...
  switch (wind) {
    ...
    do{
      ...
      //printCursor(0,30, preMas);
      //printCursor(10,30, preMas [1]);
      //printCursor(20,30, preMas [2]);
      //printCursor(30,30, preMas [3]);
      //printCursor(40,30, preMas [4]);
